...
IL_0030:
	{
		...
		NullCheck(L_8);
		bool L_9 = MixedRealityDiagnosticsProfile_get_ShowDiagnostics_mBD4B7374662D566FE3BCEC110615C077866F0D45(L_8, /*hidden argument*/NULL);
		...
		NullCheck(L_10);
		bool L_11 = MixedRealityDiagnosticsProfile_get_ShowProfiler_m8364034DE9E652F7E78B01FCDBD96EB637D78CB7(L_10, /*hidden argument*/NULL);
		...
		NullCheck(L_12);
		bool L_13 = MixedRealityDiagnosticsProfile_get_ShowFrameInfo_m3B10657C0BA6C927C5FE8CD7B05F90822172AF98(L_12, /*hidden argument*/NULL);
		...
		NullCheck(L_14);
		bool L_15 = MixedRealityDiagnosticsProfile_get_ShowMemoryStats_mD436C61254CDB18A3BE64C15F0B1DEE1E038542D(L_14, /*hidden argument*/NULL);
		...
		NullCheck(L_16);
		float L_17 = MixedRealityDiagnosticsProfile_get_FrameSampleRate_mF15748849E4992C8AC32675F1E33A7A138293F3E(L_16, /*hidden argument*/NULL);
		...
		NullCheck(L_18);
		int32_t L_19 = MixedRealityDiagnosticsProfile_get_WindowAnchor_m2618DBA5D791DFD9AFA1734E4E8BB40CA4C910E2(L_18, /*hidden argument*/NULL);
		...
		NullCheck(L_20);
		Vector2_tA85D2DD88578276CA8A8796756458277E72D073D  L_21 = MixedRealityDiagnosticsProfile_get_WindowOffset_m94AA80E762902234A3178FB97EF78F9054C81DE2(L_20, /*hidden argument*/NULL);
		...
		NullCheck(L_22);
		float L_23 = MixedRealityDiagnosticsProfile_get_WindowScale_m2CE84114B41392595670B48A7F9E4BBE9D8B31F4(L_22, /*hidden argument*/NULL);
		...
		NullCheck(L_24);
		float L_25 = MixedRealityDiagnosticsProfile_get_WindowFollowSpeed_m2D9514CE652157AD587116F7EB5EFF4C01B2D954(L_24, /*hidden argument*/NULL);
...
IL_00c4:
	...
	}
	{
		...
		V_6 = (((int32_t)((int32_t)((float)((float)(1.0f)/(float)((float)((float)L_37/(float)(((float)((float)L_38))))))))));
		// int gpuFrameRate = 0;
		V_7 = 0;
	...
	}
	{
		...
		V_7 = (((int32_t)((int32_t)((float)((float)(1.0f)/(float)((float)((float)L_50/(float)(((float)((float)L_51))))))))));
	}
...
IL_03dc:
	...
	}
	{
		...
		Vector3__ctor_m08F61F548AA5836D8789843ACB4A81E4963D2EE1((&L_158), ((float)((float)(((float)((float)(((double)((uint64_t)L_150))))))/(float)(((float)((float)(((double)((uint64_t)L_151)))))))), L_154, L_157, /*hidden argument*/NULL);
		NullCheck(L_149);
...
IL_047b:
	...
	}
	{
		...
		Vector3__ctor_m08F61F548AA5836D8789843ACB4A81E4963D2EE1((&L_182), ((float)((float)(((float)((float)(((double)((uint64_t)L_174))))))/(float)(((float)((float)(((double)((uint64_t)L_175)))))))), L_178, L_181, /*hidden argument*/NULL);
		NullCheck(L_173);
